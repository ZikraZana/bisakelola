...
<body class="bg-white d-flex flex-column min-vh-100">
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6 order-2 order-lg-1">
                    ...
                    <p class="lead text-secondary mb-4">
                        Sistem informasi manajemen desa untuk pendataan penduduk dan penyaluran bantuan sosial yang
                ...
                <div class="col-lg-6 order-1 order-lg-2 text-center">
                    <img src="https://img.freepik.com/free-vector/check-list-concept-illustration_114360-4535.jpg"
                        alt="Ilustrasi Pendataan" class="img-fluid rounded-3" style="max-height: 400px;">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="statistik-section" class="py-5 bg-light">
        <div class="container">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-5">
                    ...
                    <p class="text-secondary mb-4">
                        Berikut adalah rekapitulasi jumlah penduduk terdaftar dan realisasi penyaluran bantuan sosial
                        ...
                        <div class="col-6">
                            <div class="p-4 border rounded-4 bg-light h-100 stat-card shadow-sm">
                                ...
                                <small class="text-secondary fw-bold text-uppercase"
                                    style="font-size: 0.75rem; letter-spacing: 1px;">Total Penduduk</small>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-4 border rounded-4 bg-light h-100 stat-card shadow-sm">
                                ...
                                <small class="text-secondary fw-bold text-uppercase"
                                    style="font-size: 0.75rem; letter-spacing: 1px;">Penerima Bansos</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 stat-card">
                    <div class="card h-100 border-0 shadow-sm p-3 rounded-4">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text text-secondary">
                                Monitoring penyaluran bantuan sosial dengan riwayat penerimaan yang jelas dan
                                transparan.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 stat-card">
                    <div class="card h-100 border-0 shadow-sm p-3 rounded-4">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text text-secondary">
                                Visualisasi data demografi dan laporan realisasi bantuan dalam bentuk grafik yang mudah
                                dipahami.
                            </p>
                        </div>
                    </div>
    ...
    <footer class="bg-gradient-dark text-white py-5 mt-auto border-top border-secondary">
        <div class="container">
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled small">
                        <li class="mb-2"><a href="#statistik-section"
                                class="text-white-50 text-decoration-none">Statistik</a></li>
                        <li class="mb-2"><a href="#fitur" class="text-white-50 text-decoration-none">Fitur
                                Utama</a></li>
                        <li class="mb-2"><a href="{{ route('login') }}"
                                class="text-white-50 text-decoration-none">Login Petugas</a></li>
                    </ul>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    <small class="text-white-50">&copy; 2025 RT 14 BISA. Semua hak cipta dilindungi.</small>
                </div>
