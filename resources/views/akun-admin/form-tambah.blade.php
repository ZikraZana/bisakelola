            ...
            <form action="{{ route('akun-admin.store') }}" method="POST">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6" id="kolom-blok" style="display: none;">
                        ...
                        --}}
                        <select class="form-control @error('blok') is-invalid @enderror" id="blok_id" name="blok">
                            <option value="">Pilih Blok</option>

                            {{-- UBAH INI: Gunakan old('blok') --}}
                            <option value="Lrg. Duren" {{ old('blok') == 'Lrg. Duren' ? 'selected' : '' }}>Blok Lrg. Duren
                            </option>
                            <option value="Makakau" {{ old('blok') == 'Makakau' ? 'selected' : '' }}>Blok Makakau</option>
                            <option value="Matahari" {{ old('blok') == 'Matahari' ? 'selected' : '' }}>Blok Matahari
                            </option>
                            <option value="Lrg. Gardu" {{ old('blok') == 'Lrg. Gardu' ? 'selected' : '' }}>Blok Lrg. Gardu
                            </option>
                        </select>
                        {{-- UBAH INI: @error('blok') --}}
                        @error('blok')
