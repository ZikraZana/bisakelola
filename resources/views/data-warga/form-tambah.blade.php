                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('desil') is-invalid @enderror" id="desil" name="desil">
                            ...
                            <option value="" @if (old('desil') == '') selected @endif>Tidak ada desil</option>
                        </select>
                        @error('desil')
                            <i class="text-danger small">{{ $message }}</i>
                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select
                                            ...
                                            <option value="Kepala Keluarga"
                                                @if (isset($anggota['status_dalam_keluarga']) && $anggota['status_dalam_keluarga'] == 'Kepala Keluarga') selected @endif>Kepala Keluarga</option>
                                            <option value="Istri" @if (isset($anggota['status_dalam_keluarga']) && $anggota['status_dalam_keluarga'] == 'Istri') selected @endif>
                                                Istri</option>
                                            <option value="Anak" @if (isset($anggota['status_dalam_keluarga']) && $anggota['status_dalam_keluarga'] == 'Anak') selected @endif>Anak
                                            </option>
                                        </select>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addButton.addEventListener('click', function() {
                ...
                // Tambahkan tombol hapus jika ini bukan form pertama
