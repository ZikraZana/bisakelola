                ...
                <div class="card shadow-sm border-0 rounded-3">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="alert alert-light border mb-4">
                            <h6 class="fw-bold text-secondary mb-3"><i class="bi bi-info-circle me-2"></i>Detail Pengajuan
                            </h6>
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="fw-bold mb-0">
                                        {{ $pengajuan->keluarga->anggotaKeluarga->firstWhere('status_dalam_keluarga', 'Kepala Keluarga')->nama_lengkap ?? '-' }}
                                    </p>
                                </div>
                                <div class="col-md-12">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <div
                                        class="form-check card p-3 h-100 {{ old('status_acc', $pengajuan->status_acc) == 'Diajukan' ? 'bg-light-warning border-warning' : '' }}">
                                        <input class="form-check-input status-radio" type="radio" name="status_acc"
                                            id="st_diajukan" value="Diajukan"
                                ...
                                <div class="col-md-4">
                                    <div
                                        class="form-check card p-3 h-100 {{ old('status_acc', $pengajuan->status_acc) == 'Disetujui' ? 'bg-light-success border-success' : '' }}">
                                        <input class="form-check-input status-radio" type="radio" name="status_acc"
                                            id="st_setuju" value="Disetujui"
                                ...
                                <div class="col-md-4">
                                    <div
                                        class="form-check card p-3 h-100 {{ old('status_acc', $pengajuan->status_acc) == 'Ditolak' ? 'bg-light-danger border-danger' : '' }}">
                                        <input class="form-check-input status-radio" type="radio" name="status_acc"
                                            id="st_tolak" value="Ditolak"
                        ...
                        <div id="section-detail-bantuan" class="row g-3 mb-4 p-4 bg-light rounded-3 border">
                            <div class="col-12">
                                <h6 class="fw-bold text-success mb-0"><i class="bi bi-check-lg me-2"></i>Detail Bantuan
                                    (Wajib Diisi)</h6>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('id_bansos') is-invalid @enderror" name="id_bansos">
                                    ...
                                    @foreach ($masterBansos as $bansos)
                                        <option value="{{ $bansos->id_bansos }}"
                                            {{ old('id_bansos', $pengajuan->id_bansos) == $bansos->id_bansos ? 'selected' : '' }}>
                                            {{ $bansos->nama_bansos }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('periode') is-invalid @enderror"
                                    name="periode" placeholder="Cth: Triwulan 1 2025"
                                    value="{{ old('periode', $pengajuan->periode) }}">
                                @error('periode')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div id="section-catatan-keputusan" class="mb-4">
                            <label class="form-label">Catatan Keputusan (Opsional)</label>
                            <textarea class="form-control" name="keterangan_acc" rows="2" placeholder="Alasan persetujuan atau penolakan...">{{ old('keterangan_acc', $pengajuan->keterangan_acc) }}</textarea>
                        </div>
                        ...
                        @if ($pengajuan->status_acc == 'Disetujui')
                            <div class="card bg-primary-subtle border-primary mb-3">
                                <div class="card-body">
                                    <h6 class="fw-bold text-primary mb-3"><i class="bi bi-box-seam me-2"></i>Update Status
                                        Penyaluran</h6>
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            <p class="small mb-2 mb-md-0">
                                                ...
                                                <br>Status saat ini:
                                                <strong>{{ $pengajuan->status_bansos_diterima }}</strong>
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <select class="form-select border-primary" name="status_bansos_diterima">
                                                <option value="Belum"
                                                    {{ $pengajuan->status_bansos_diterima == 'Belum' ? 'selected' : '' }}>
                                                    Belum Diterima</option>
                                                <option value="Sudah Diterima"
                                                    {{ $pengajuan->status_bansos_diterima == 'Sudah Diterima' ? 'selected' : '' }}>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const detailCatatanSection = document.getElementById('section-catatan-keputusan');
            ...
            function toggleSections() {
                ...
                // Toggle both sections based on selected value
                if (selectedValue === 'Disetujui') {
                    detailSection.classList.remove('d-none');
                    detailCatatanSection.classList.remove('d-none');
                }
                if (selectedValue === 'Disetujui' || selectedValue === 'Ditolak') {
                    ...
                    detailSection.classList.add('d-none');
                    detailCatatanSection.classList.add('d-none');
                }
            }

            radioButtons.forEach(radio => radio.addEventListener('change', toggleSections));
